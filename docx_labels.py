...
def _add_divider(
    ...
    An empty paragraph still takes up a full default-size line
    of height even with space_before/after at 0, so we add a
    run with a near-zero font size to collapse the line height
    down to just the border itself.
    """
